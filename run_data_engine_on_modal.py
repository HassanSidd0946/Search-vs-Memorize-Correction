...
def run_full_pipeline():
    ...
    # F-SILENT hardening: make partial merges impossible to miss. A subject
    # silently failing upstream (e.g. sub-09's truncated .eeg export) must
    # never produce a "clean-looking" merged dataset with fewer subjects
    # than expected — fail loud here instead of relying on a human noticing
    # `failed_subjects` in the log.
    n_merged = len(all_X)
